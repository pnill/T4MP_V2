...
public:
	...
	char pad_0x00C4[0x117C]; //0x00C4 - Padding to reach 0x1240
	DMPlayer* pDMPlayer; //0x1240
}; //Size=0x00C4
...
public:
	...
	int field_23A8; // 0x23A8
	char pad_0x23A8[0x50]; //0x23AC
}; //Size=0x23F8
